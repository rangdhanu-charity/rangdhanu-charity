...
export const ReceiptService = {
    ...
    generateDonationReceipt: async (payment: any): Promise<jsPDF> => {
        ...
        renderUnicodeText(doc, typeStr, 55, detailY - 2.375, 9.5, false, '#475569', 55);
        ...
        renderUnicodeText(doc, payment.memberName || 'Guest Donor', 133, yCol2 + 4.625, 9.5, false, '#475569', 65);
        ...
        if (donorPhone) {
            ...
            renderUnicodeText(doc, donorPhone, 133, currentDonorY - 2.375, 9.5, false, '#475569', 65);
            currentDonorY += 7;
        }
        if (donorEmail) {
            doc.setFont('helvetica', 'bold');
            ...
            renderUnicodeText(doc, donorEmail, 133, currentDonorY - 2.375, 9.5, false, '#475569', 65);
            currentDonorY += 7;
        }
